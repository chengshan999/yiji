...
class IndexAction extends BaseAction{
	...
	protected function _initialize(){
		parent::_initialize();
		$this->home_theme=$this->home_theme?$this->home_theme:'weimicms'; //模板目录名字
	...
	public function index(){
		...
		//$this->display($this->home_theme.':Index:'.ACTION_NAME);
		$this->redirect("index.php?g=Wap&m=Active&a=index");
	}
        //用户登出
	...
	function common(){
	 ...
	 public function userJson(){
    	if (C('server_topdomain')=='weimicms.cn'&&$this->_get('key')==C('server_key')){
    		$id=intval($_GET['id']);
	...
	public function login(){
		$business = include('./weimicms/Lib/ORG/Business.php');
		$i=0;
