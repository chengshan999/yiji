...
class LinkAction extends UserAction{
	...
	public function keywordModules(){
		...
		array('module'=>'Repast','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Repast&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Repast'],'sub'=>0,'canselected'=>1,'linkurl'=>'','keyword'=>'外卖','askeyword'=>1),
		...
		//添加功能库 BY H 20140901
		array('module'=>'Dxs','linkcode'=>'','name'=>'读心术','sub'=>0,'canselected'=>1,'linkurl'=>'','keyword'=>'读心术','askeyword'=>1),
		...
		array('module'=>'Baoming','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Baoming&a=lists&token='.$this->token.'&wecha_id={wechat_id}','name'=>'报名活动','sub'=>0,'canselected'=>1,'linkurl'=>'','keyword'=>'报名活动','askeyword'=>1),
		//20141202新增功能介绍
        array('module'=>'Invite','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Invite&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Invite'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>0),
		array('module'=>'Fenlei','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Fenlei&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Fenlei'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>0),
		array('module'=>'Jingcai','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Jingcai&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Jingcai'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>0),
		array('module'=>'Punish','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Punish&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Punish'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>0),
		array('module'=>'Reservation','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Reservation&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Reservation'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>0),
	...
	public function modules(){
		...
		array('module'=>'Game','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Game&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Game'],'canselected'=>1,'linkurl'=>'','keyword'=>'','askeyword'=>0),
		array('module'=>'Baoming','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Baoming&a=idnex&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Baoming'],'sub'=>1,'canselected'=>1,'linkurl'=>'','keyword'=>'','askeyword'=>0),
		array('module'=>'Jikedati','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Jikedati&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Jikedati'],'canselected'=>1,'linkurl'=>'','keyword'=>'','askeyword'=>0),
		array('module'=>'Fanyan','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Fanyan&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Fanyan'],'canselected'=>1,'linkurl'=>'','keyword'=>'','askeyword'=>0),
...
//外链小工具
	...
	public function OutsideLink(){
		//处理小工具数组文件
			$f = include('./weimicms/Lib/ORG/Func.links.php');
		//取出分类总汇
			$i=0;
