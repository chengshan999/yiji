...
<div class="main">
    ...
    <div class="jifeng-content">
        ...
        <form action="" id="add" method="post">
            <p class="clearfix"><span>姓名</span><input type="text" value="<?php echo ($dizhi["xingming"]); ?>" name="xingming" placeholder="请输入.."></p>
            <p class="clearfix"><span>电话</span><input type="text" value="<?php echo ($dizhi["tel"]); ?>" name="tel" placeholder="请输入.."></p>

			<input type="hidden" name="id" value="<?php echo ($dizhi["id"]); ?>" />
           ...
           <div style="margin-top:1rem;border-bottom: 1px solid #fff;padding-left: 0.5rem"><input type="text" name="addr" value="<?php echo ($dizhi["addr"]); ?>" style="width:100%;height: 3rem;background: transparent;color: #fff" placeholder="请输入详细地址"/></div>
