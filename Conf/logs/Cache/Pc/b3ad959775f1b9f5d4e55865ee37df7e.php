    ...
    <div class="login">
        ...
        <form action="" method="post">
            <div class="login_box_lit">
                <div class="login_box_detail">
                    <div class="login_welcome"><img src="<?php echo RES;?>/img/welcome.png" alt=""/></div>
                    <div class="login_denglu">登录</div>
                    <div class="login_name">手机号 <br/> <input name="tel" type="text" placeholder="请输入手机号"/></div>
                    <div class="login_name">密码 <br/> <input name="password" type="password" placeholder="请输入密码"/></div>
                    <div class="login_name login_zt">
                        <div class="login_jz"><input type="checkbox" name="denglu"/>记住登录状态</div>
                        <a href=""><span class="login_zc">忘记密码?</span> </a>
                        <a href="__URL__/reg"><span class="login_zc login_wj ">快速注册</span></a>
                    </div>
                    <div class="login_name"><input type="submit" id="denglu"  value="登录"/></div>
                </div>
            </div>
            </form>
        </div>
