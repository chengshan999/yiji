    ...
    <div class="center-right-center f-l" style="width:100%">
        ...
        <div class="orders-content share  ">
            ...
            <div class="gwc-orders-tianxie">
                ...
                <div class="order-xiangqing">
                    <div class="order-4"><img style="width:73%;" src="<?php echo ($order["pic"]); ?>" alt="" class="img-responsive"></div>
                    <div class="order-2">
                        <?php echo ($order["productName"]); ?>
                    </div>
                    <div class="order-4" style="text-indent: -50px;">积分商品</div>
                    <div class="order-3"><?php echo ($order["point"]); ?></div>
                    <div class="order-3 number">
                        <span>1</span>
                    </div>
                    <div class="order-4">
                        <?php echo ($order["point"]); ?>积分
                    </div>
                    <div class="order-4 del">
...
<script>
	function tijiao(){
		...
		location.href="__URL__/jifen_order_save/order_id/<?php echo ($order["id"]); ?>/shouhuo_id/"+shouhuo_id;
	}
</script>