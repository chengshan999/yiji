...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" >
    ...
    <div class="carousel-inner text-center" role="listbox">
        <div class="item active">
            <img  style="width: 100%" src="<?php echo RES;?>/img/registration_banner.jpg" alt="...">
...
<div class="content">
    <div class="news_box">
        <div class="news_head"><a href="__GROUP__/Index/index">首页</a>&gt;在线报名</div>
        <div class="registration">
            <div class="registration_head">在线报名</div>
