...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" >
    ...
    <div class="carousel-inner text-center" role="listbox">
        <div class="item active">
            <img  style="width: 100%" src="<?php echo RES;?>/img/professors_banner.jpg" alt="...">
...
<div class="content">
    <div class="news_box">
        <div class="public_a">
            <div class="public_a_t">讲师</div>
            <div class="public_a_e">
                <div class="public_a_a  public_a_vip">院内讲师 <span class="public_a_vip"> > </span></div>
                <div class="public_a_a">特邀讲师<span> > </span></div>
            </div>
        </div>
        <div class="public_b">
            <div style="display: block;">
                <div class="news_head"><span>院内讲师</span><a href="__GROUP__/Index/index">首页</a>&gt;<a href="javascript:void(0);">讲师</a>&gt;<a href="javascript:void(0);">院内讲师</a></div>
                <div class="professors_content">
                    <div>
                        <div class="professors_box_box">
                            <div class="professors_box_pic"><img src="<?php echo RES;?>/img/professrors_a.jpg" alt=""/></div>
                            <div class="professors_box_name">
                                <h3>张三</h3>
                                <span>设计教授</span>
                            </div>
                            <div class="professors_box_detail" >
                                <p>个人时间,管理哦技能在任何生活领域的专业和个人的成功是必不可少的。能够成功实施时间管理策略能够成功实施时间管理策略个时间,管理哦技能在任何生活领域的专业和个人的成功是必不可少的。能够成功实施时间管理策略能够成功实施时间管理策略
                                </p>
                            </div>

                        </div>
                        <div class="professors_box_box">
                            <div class="professors_box_pic"><img src="<?php echo RES;?>/img/professrors_b.jpg" alt=""/></div>
                            <div class="professors_box_name">
                                <h3>李四</h3>
                                <span>设计教授</span>
                            </div>
                            <div class="professors_box_detail" id="clamp-this-module">
                                <p>个人时间管理哦技能在任何生活领域的专业和个人的成功是必不可少的</p>
                            </div>

                        </div>
                        <div class="professors_box_box">
                            <div class="professors_box_pic"><img src="<?php echo RES;?>/img/professrors_c.jpg" alt=""/></div>
                            <div class="professors_box_name">
                                <h3>张三</h3>
                                <span>设计教授</span>
                            </div>
                            <div class="professors_box_detail">
                                <p>个人时间管理哦技能在任何生活领域的专业和个人的成功是必不可少的。能够成功实施时间管理策略能够成功实施时间管理策略.</p>
                            </div>

                        </div>
                        <div class="professors_box_box">
                            <div class="professors_box_pic"><img src="<?php echo RES;?>/img/professrors_d.jpg" alt=""/></div>
                            <div class="professors_box_name">
                                <h3>张三</h3>
                                <span>设计教授</span>
                            </div>
                            <div class="professors_box_detail">
                                <p>个人时间管理哦技能在任何生活领域的专业和个人的成功是必不可少的。能够成功实施时间管理策略.</p>
                            </div>

                        </div>
                        <div class="professors_box_box">
                            <div class="professors_box_pic"><img src="<?php echo RES;?>/img/professrors_e.jpg" alt=""/></div>
                            <div class="professors_box_name">
                                <h3>张三</h3>
                                <span>设计教授</span>
                            </div>
                        ...
                        <div class="professors_box_box">
                            <div class="professors_box_pic"><img src="<?php echo RES;?>/img/professrors_f.jpg" alt=""/></div>
                            <div class="professors_box_name">
                                <h3>张三</h3>
                                <span>设计教授</span>
                            </div>
                        ...
                        <div class="professors_box_box">
                            <div class="professors_box_pic"><img src="<?php echo RES;?>/img/professrors_g.jpg" alt=""/></div>
                            <div class="professors_box_name">
                                <h3>张三</h3>
                                <span>设计教授</span>
                            </div>
                        ...
                        <div class="professors_box_box">
                            <div class="professors_box_pic"><img src="<?php echo RES;?>/img/professrors_h.jpg" alt=""/></div>
                            <div class="professors_box_name">
                                <h3>张三</h3>
                                <span>设计教授</span>
                            </div>
            ...
            <div >
                <div class="news_head"><span>特邀讲师</span><a href="__GROUP__/Index/index">首页</a>&gt;<a href="javascript:void(0);">讲师</a>&gt;<a href="javascript:void(0);">特邀讲师</a></div>
                <div class="professors_content">
                    <div>
                        <div class="professors_box_box">
                            <div class="professors_box_pic"><img src="<?php echo RES;?>/img/professrors_a.jpg" alt=""/></div>
