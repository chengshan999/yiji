...
<div class="content">
    <div class="news_box">
        <div class="public_a">
            <div class="public_a_t">联系我们</div>
            <div class="public_a_e">
                <div class="public_a_a  public_a_vip">商务合作 <span class="public_a_vip"> > </span></div>
                <div class="public_a_a">招聘英才<span> > </span></div>
                <div class="public_a_a">联系我们<span> > </span></div>
            </div>
        </div>
        <div class="public_b">
            <div>
                <div class="news_head"><span>商务合作</span><a href="__GROUP__/Index/index">首页</a>&gt;<a href="javascript:void(0);">联系我们</a>&gt;<a href="javascript:void(0);">商务合作</a></div>
                <div style="width: 100%;padding:3% 20%;"><img style="width: 100%;" src="<?php echo RES;?>/images/waitting.jpg" alt=""/></div>
            </div>

            <div >
                <div class="news_head"><span>招聘英才</span><a href="__GROUP__/Index/index">首页</a>&gt;<a href="javascript:void(0);">联系我们</a>&gt;<a href="javascript:void(0);">招聘英才</a></div>
                <div style="width: 100%;padding:3% 20%;"><img style="width: 100%;" src="<?php echo RES;?>/images/waitting.jpg" alt=""/></div>
            </div>
            <div >
                <div class="news_head"><span>联系我们</span><a href="__GROUP__/Index/index">首页</a>&gt;<a href="javascript:void(0);">联系我们</a>&gt;<a href="javascript:void(0);">联系我们</a></div>
                <div class="lxwm_a">
                    <img src="<?php echo RES;?>/images/map.png" alt=""/>
                </div>
                <div class="lxwm_b">
                    <h3>全国客服： <br/>400-002-5135</h3>
                    <h4>福盈集团（上海总部）</h4>
                    <p>地址：上海市长宁区仙霞路99号尚嘉中心(LV大楼)6楼</p>
                    <p>EMAIL：welcome@fxigroup.com</p>
                </div>
                <div class="clear"></div>
            </div>
        </div>
