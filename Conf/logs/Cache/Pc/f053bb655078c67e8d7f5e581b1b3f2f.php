...
<div class="content">
    <div class="news_box">
        <div class="public_a">
            <div class="public_a_t">活动</div>
            <div class="public_a_e">
                <div class="public_a_a  public_a_vip">人气讲座 <span class="public_a_vip"> > </span></div>
                <div class="public_a_a">投资交流会<span> > </span></div>
            </div>
        </div>
        <div class="public_b">
            <div>
                <div class="news_head"><span>人气讲座</span><a href="__GROUP__/Index/index">首页</a>&gt;<a href="javascript:void(0);">活动</a>&gt;<a href="javascript:void(0);">人气讲座</a></div>
                <div class="public_b_box">
                    <div class="E_about_b">
                        <img src="<?php echo RES;?>/images/lecture_a.jpg" alt=""/>
                    </div>
                    <div class="E_about_a">
                        <ol>
                            <li><span>由学院邀请在金融机构与交易有关的专业人士主讲或分享的线下讲座。</span></li>
                            <li><span>由学院组织各级学员毕业生的线下交流活动。</span></li>
                            <li><span>线上技术指标及交易心得分享交流论坛。</span></li>
                            <li><span>年度大型论坛活动。</span></li>
                            <li><span>凝聚学员与学院之间的关系，挖掘优秀的毕业学员并为集团日后规划所用。</span></li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div style="display: none;">
                <div class="news_head"><span>投资交流会</span><a href="__GROUP__/Index/index">首页</a>&gt;<a href="javascript:void(0);">活动</a>&gt;<a href="javascript:void(0);">投资交流会</a></div>
