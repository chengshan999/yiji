...
<body>
    ...
    <style>
.jifen-pro>div{position:relative;}
</style>
<div class="content-center" style="margin-bottom:10%;">
    ...
    <div class="center-left f-l">
        <ul>
            ...
            <a href="__URL__/points"><li class="centerbgc">积分商城</li></a>
    ...
    <div class="center-right f-l">
    	<div class="center-jifen" >
                    <div class="center-data-title">我的积分: <span><?php echo ($user["points"]); ?></span></div>
                    <div class="center-jifen-title2">
                    <form action="" method="post">
                        <div>搜索礼品 <input  class="jifen-text" name="key" type="text"/> <input class="jifen-btn" type="button" value="搜索"/></div>
                        </form>
                    </div>
                    <div class="jifen-pro">
                    	<?php if(is_array($product)): foreach($product as $key=>$v): ?><div><span class="jfpron"><?php echo ($v["productName"]); ?></span> <br/> <img style="width:100%;" src="<?php echo ($v["pic"]); ?>" alt=""/> <br/> <span class="pro-jf"><?php echo ($v["point"]); ?></span>积分 <span class="pro_sy">剩余<span style="color:#f499c0;"><?php echo ($v["kucun"]); ?></span>件</span><div class="jifen-dh">
                        <span onclick="tijiao(<?php echo ($v["id"]); ?>)" style="cursor:pointer" class="ljdh">立即兑换</span>
...
<script type="text/javascript">
    function tijiao(o){
    	var id=o;
    	$.ajax({
    		url:"<?php echo U('Product/jifen_save_order');?>",
    		data:{id:id},
    		type:"POST",
    		success:function(data){
    			if(data=="unenough"){
    				...
    				location.href="__GROUP__/Product/jifen_order/order_id/"+data;
    			}else{
    				alert("系统繁忙，请稍后重试");
    				return false;
    			}
