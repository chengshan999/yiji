...
<div class="sign-content sign-contentcg">
   <div class="csgc">
       <div class="csgcpic"><img src="<?php echo RES;?>/images/sucess.png" alt=""/></div>
       <div class="csgcone">
           <span>恭喜您设置成功</span><br/>
           <span class="csgcone-dl"><a  href="__URL__/denglu">点击立即登录</a></span>
       </div>
   </div>
</div>
