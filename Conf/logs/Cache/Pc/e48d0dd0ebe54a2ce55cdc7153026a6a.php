...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" >
    ...
    <div class="carousel-inner text-center" role="listbox">
        <div class="item active">
            <img  style="width: 100%" src="<?php echo RES;?>/img/matches_banner.jpg" alt="...">
...
<div class="content">
    <div class="news_box">
        <div class="public_a">
            <div class="public_a_t">比赛</div>
            <div class="public_a_e">
                <div class="public_a_a  public_a_vip">院内比赛 <span class="public_a_vip"> > </span></div>
                <div class="public_a_a">实盘比赛<span> > </span></div>
                <div class="public_a_a">课程模拟<span> > </span></div>
            </div>
        </div>
        <div class="public_b">
            <div>
                <div class="news_head"><span>院内比赛</span><a href="__GROUP__/Index/index">首页</a>&gt;<a href="javascript:void(0);">比赛</a>&gt;<a href="javascript:void(0);">院内比赛</a></div>
                <div class="matches_content">
                    <div class="matches_ct_box" >
                    	<?php if(is_array($chuji)): foreach($chuji as $key=>$v): ?><div class="matches_box_box">
                            <div class="matches_box_pic"><img src="<?php echo ($v["pic"]); ?>" alt=""/></div>
            ...
            <div >
                <div class="news_head"><span>实盘比赛</span><a href="__GROUP__/Index/index">首页</a>&gt;<a href="javascript:void(0);">比赛</a>&gt;<a href="javascript:void(0);">实盘比赛</a></div>
                <div class="matches_content">
                    <div class="matches_ct_box" >
                        
                        <?php if(is_array($zhongji)): foreach($zhongji as $key=>$v): ?><div class="matches_box_box">
                            <div class="matches_box_pic"><img src="<?php echo ($v["pic"]); ?>" alt=""/></div>
                            <div class="matches_box_name">
                                <h4><?php echo ($v["productName"]); ?></h4>
                                <span><?php echo ($v["time"]); ?></span>
            ...
            <div >
                <div class="news_head"><span>课程模拟</span><a href="__GROUP__/Index/index">首页</a>&gt;<a href="javascript:void(0);">比赛</a>&gt;<a href="javascript:void(0);">课程模拟</a></div>
                <div class="matches_content">
                    <div class="matches_ct_box" >
                        <?php if(is_array($gaojiji)): foreach($gaojiji as $key=>$v): ?><div class="matches_box_box">
                            <div class="matches_box_pic"><img src="<?php echo ($v["pic"]); ?>" alt=""/></div>
                            <div class="matches_box_name">
                                <h4><?php echo ($v["productName"]); ?></h4>
                                <span><?php echo ($v["time"]); ?></span>
