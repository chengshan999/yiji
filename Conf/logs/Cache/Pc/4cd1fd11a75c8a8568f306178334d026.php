...
<div class="sign-content">
    <h1>WELCOME</h1>
    <h4>设置新密码</h4>
    <form action="__URL__/zhaohui_finish" method="post">
    <input type="hidden" name="tel" value="<?php echo ($tel); ?>" />
        <input type="password" class="input" name="pwd" placeholder="请输入密码"><span class="mm2 top1"></span>
        <input type="password" class="input " name="re_pwd"  placeholder="请再次输入密码"><span class="mm3 top2"></span>
        <input type="button" id="tijiao" value="设置完成" class="input">
    </form>
</div>
...
$("#tijiao").click(function(){
	...
	var pwd2=$("input[name=re_pwd]").val();
	if(pwd1!=pwd2){
		alert("两次密码不一致");
		return false;
	}else{
