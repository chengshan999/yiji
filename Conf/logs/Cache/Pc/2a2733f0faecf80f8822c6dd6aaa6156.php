...
<div class="content-center ">
    ...
    <div class="center-right-order f-l">
        <div class="center-right-order-name" >订单生成成功</div>
        <div class="border1"></div>
        <!--提交订单 begin-->

        <div class="gwc-orders-tj-content  share ">
            <div class="gwc-orders-tj-dis">
                <img src="/tpl/Pc/default/common/images/sucess.png" alt="" class="img-responsive">
                <p><span>你的订单提交成功</span><br>
                    <span>花费积分:<?php echo ($point); ?></span>
                </p>
            </div>
            <div style="clear:both;"></div>
            <div class="border"></div>
            <div class="zf">
                <a href="__Users__/my_jifen_order">点击查看</a>
            </div>
