...
<script type="text/javascript">
       ...
       <!-- <ol class="carousel-indicators">
        ...
        <div class="carousel-inner text-center" role="listbox">
            <div class="item active">
                <img  style="width: 100%" src="<?php echo RES;?>/img/news_banner.jpg" alt="...">
    ...
    <div class="content">
        <div class="news_box">
            <div class="news_head"><a href="__GROUP__/Index/index">首页</a>&gt;新闻</div>
            <div class="news_content">
            	<?php if(is_array($data)): foreach($data as $key=>$v): ?><div class="news_content_box">
                <a  href="__GROUP__/Product/news_detail/id/<?php echo ($v["id"]); ?>">
                        <img  style="width:100%;height:308px;" src="<?php echo ($v["pic"]); ?>" alt=""/>
                        <div>
                            <span><?php echo ($v["title"]); ?></span>
                            <p><?php echo (date("Y.m.d",$v["createtime"])); ?></p>
                        </div>
                        </a>
