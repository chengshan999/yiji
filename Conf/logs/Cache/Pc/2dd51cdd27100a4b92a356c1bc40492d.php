...
<script type="text/javascript">
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" >
        ...
        <div class="carousel-inner text-center" role="listbox">
            <div class="item active">
                <img  style="width: 100%" src="{weimicms:RES}/img/center_banner.jpg" alt="...">
    ...
    <div class="content" style="margin-bottom: 100px;">
        <div class="news_box pay_top">
            <div class="pay_top_t pay_wx_top">微信支付</div>
            <div class="pay_wx_b">请扫面二维码支付<span>&yen;168.00</span>元</div>
            <div class="pay_wx_c">
                <img src="__URL__/zhifu_code/order_id/<?php echo ($order_id); ?>" alt=""/>
            </div>
        </div>
    </div>
    <!--content  end-->
...
<script type="text/javascript" src="{weimicms:RES}/js/index.js"></script>
<script>
var idInt = setInterval(function(){
	...
	$.ajax({
		...
		success:function(data){
			if(data!='false'){
				location.href='__URL__/finish/order_id/'+data;
			}else{
				return false;
			}
		}
