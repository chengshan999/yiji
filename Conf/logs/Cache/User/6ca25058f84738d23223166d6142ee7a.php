...
<div class="tab">
<ul>
<li class="current tabli" id="tab0">讲师管理</li>
</ul>
</div>
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left" style="margin-left:20px"> <a href="<?php echo U('Jiangshi/add_jiangshi',array('name'=>Jiangshi));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加讲师</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
<form method="post" action="" >
...
<td><?php echo ($vo["zhiwei"]); ?></td>
<td><a target="_blank" href="<?php echo ($vo["pic"]); ?>"><img src="<?php echo ($vo["pic"]); ?>" style="width:50px;" alt="" /></a></td>
<td><?php echo ($vo["type"]); ?></td>
<td class="norightborder"><a href="<?php echo U('Jiangshi/edit',array('id'=>$vo['id'],'token'=>$token,'name'=>'Jiangshi'));?>">修改</a>   <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Jiangshi/delete',array('id'=>$vo['id'],'token'=>$token));?>');">删除</a></td>
