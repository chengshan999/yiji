...
<div class="tab">
<ul>
<li class="current tabli" id="tab0">课程管理</li>
</ul>
</div>
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left" style="margin-left:20px"> <a href="<?php echo U('Blproduct/addproduct',array('name'=>Product));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加课程</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
<form method="post" action="" >
...
<tr>
<th width="60">排序</th>
<th width="180">课程名称名称</th>
<th width="100">图片</th>
<th width="200">课程简介</th>
<th width="100">售卖价格</th>
...
<td><a target="_blank" href="<?php echo ($vo["pic"]); ?>"><img src="<?php echo ($vo["pic"]); ?>" style="width:50px;" alt="" /></a></td>
<td><?php echo ($vo["jianjie"]); ?></td>
<td><?php echo ($vo["price"]); ?></td>
<td class="norightborder"><a href="<?php echo U('Blproduct/update',array('id'=>$vo['id'],'token'=>$token,'name'=>'Product'));?>">修改</a>   <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Blproduct/delete',array('id'=>$vo['id'],'token'=>$token));?>');">删除</a></td>
