...
<link rel="stylesheet" type="text/css" href="./tpl/User/default/common/css/cymain.css" />
 ...
 <link href="<?php echo RES;?>/css/index_two.css" rel="stylesheet">
<script type="text/javascript" src="<?php echo RES;?>/css/diymen/tipswindown.js"></script>
<script src="<?php echo RES;?>/js/echarts.js"></script>
<script src="<?php echo RES;?>/js/index.js"></script>
...
<div class="msgWrap">
<p class="userinfo"><span><?php echo ($userinfo["name"]); ?>：<i><?php echo (session('uname')); ?></i></span>
<span>本次登录时间：<i><?php echo (date("Y-m-d H:i:s",$thisUser["lasttime"])); ?></i></span>
<span>本次登录IP：<i><?php echo ($thisUser["lastip"]); ?></i></span></p>
<div class="row">
    <div class="col-lg-4">
        <div class="user user-infor">
            <div class="head">
            	<input type="hidden" id="week_money" value="<?php echo ($week_money); ?>" />
            	<input type="hidden" id="today_money" value="<?php echo ($today_money); ?>" />
            	<input type="hidden" id="seven_date" value="<?php echo ($seven_date); ?>" />
                <strong>管家统计</strong><span class="admin-icon icon"></span>
            </div>
            <div class="user-bj user-font">
            	<span class="span">已认证</span>
                <span class="font font-black user-font"><?php echo ($gj_r_count); ?></span>
            </div>
            <div class="user-value">
                <span>已关注：<?php echo ($gj_gz); ?> &nbsp;&nbsp;&nbsp;已注册：<?php echo ($gj_z_count); ?></span>
            </div>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="user user-infor">
            ...
            <div class="user-bj user-font">
            	<span class="span">已认证</span>
                <span class="font font-black user-font"><?php echo ($zh_r_count); ?></span>
            </div>
            <div class="user-value">
                <span>已关注：<?php echo ($zh_gz); ?> &nbsp;&nbsp;&nbsp;已注册：<?php echo ($zh_z_count); ?></span>
            </div>
        </div>
    </div>
    <div class="col-lg-4" style="width:32%;">
        <div class="user user-infor">
            ...
            <div class="user-bj user-font">
                ...
                <span class="font font-black user-font" ><?php echo ($dj_w_count); ?></span>
            </div>
            <div class="user-value">
                <span>待确认：<?php echo ($dj_dc_count); ?> &nbsp;&nbsp;&nbsp;处理中：<?php echo ($dj_cz_count); ?>&nbsp;&nbsp;&nbsp;已评价：<?php echo ($dj_yp_count); ?></span>
            </div>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-lg-4 " >
        <div class="user guanzhu" >
            <strong>昨日关注住户:</strong><span class="font font-black"><?php echo ($gz_count); ?></span>
        </div>
        <div class="user guanzhu" >
            <strong>今日注册住户:</strong><span class="font font-black"><?php echo ($zc_count); ?></span>
        </div>
    </div>
    <div class="col-lg-8">
...
<div class="row" style="clear:both;">
    <div class="col-lg-12">
        <div class="user user-historic">
            ...
            <?php if($wait_order == null): ?><p style="padding-top:30px;text-align: center;color: #a8a8a8;">暂无数据</p><?php endif; ?>
			<?php if(is_array($wait_order)): foreach($wait_order as $key=>$v): ?><span class="orders-span orders orders-loan2">
                <?php echo ($v["big_type"]); ?>
           </span>
           <span class="orders-span orders orders-loan2">
           <?php if(is_array($v["yuyue_type"])): foreach($v["yuyue_type"] as $key=>$vo): echo ($vo["product_name"]); ?>X<?php echo ($vo["num"]); ?><br/><?php endforeach; endif; ?>
           </span>
           <span class="orders-span orders orders-dis" style="text-align: justify"><?php echo ($v["orderid"]); ?></span>
           <span class="orders-span orders orders-loan1"><?php echo ($v["total_price"]); ?>元</span>
           <span class="orders-span orders orders-loan1"><?php echo ($v["xingming"]); ?></span>
           <span class="orders-span orders orders-loan2"><?php echo ($v["phone"]); ?></span>
           <span class="orders-span orders orders-loan2"><?php echo ($v["yu_date"]); ?></span>
           <span class="orders-span orders orders-loan1"><?php echo ($v["yu_time"]); ?></span>
		   <span class="orders-span orders orders-loan2"><?php echo ($v["floor_num"]); ?>号<?php echo ($v["room_num"]); ?>室</span>
		   <span class="orders-span orders orders-dis" style="text-align: justify"><?php echo ($v["description"]); ?></span>
...
<div class="row" style="clear:both;">
    <div class="col-lg-12">
        <div class="user user-historic">
            ...
            <?php if($end_order == null): ?><p style="padding-top:30px;text-align: center;color: #a8a8a8;">暂无数据</p><?php endif; ?>
            <?php if(is_array($end_order)): foreach($end_order as $key=>$v): ?><span class="orders-span orders orders-loan2">
                <?php echo ($v["big_type"]); ?>
           </span>
           <span class="orders-span orders orders-loan2">
           <?php if(is_array($v["yuyue_type"])): foreach($v["yuyue_type"] as $key=>$vo): echo ($vo["product_name"]); ?>X<?php echo ($vo["num"]); ?><br/><?php endforeach; endif; ?>
