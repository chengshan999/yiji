...
<style>
.userinfoArea th{width: 220px;}
</style>
<div class="content">
          <div class="cLineB"><h4>设置用户分组</h4><a href="javascript:history.go(-1);"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a></div>
         
          <form method="post"   action=""  enctype="multipart/form-data" >
          <div class="msgWrap form">
            <TABLE class="userinfoArea" border="0" cellSpacing="0" cellPadding="0" width="100%">
                          <TR>
                  <TH valign="top"><label for="pic">分组名称：</label></TH>
                  <TD><input class="px"  name="name" id="name" value="<?php echo ($thisGroup[name]); ?>"  style="width:80px;"  />
</TD>
                </TR>
                          <TR>
                  <TH valign="top"><label for="pic">等级：</label></TH>
                  <TD><input class="px"  name="grade" value="<?php echo ($thisGroup[grade]); ?>"  style="width:80px;"  />
</TD>
                </TR>
                <?php if(is_array($product)): foreach($product as $key=>$v): ?><TR>
                  <TH valign="top"><label for="pic"><?php echo ($v["productName"]); ?> 价格：</label></TH>
                  <TD><input class="px"  name="price[<?php echo ($v["id"]); ?>]" value="<?php echo ($thisGroup[price][$v[id]]); ?>" style="width:80px;"  />
				</TD>
                </TR><?php endforeach; endif; ?>
                <TR>
                  <TH></TH>
                  <TD><input type="submit" value="保存" name="sbmt" class="btnGreen left"></TD>
                </TR>
              </TBODY>
            </TABLE>
