...
function calDiscount(){
  ...
  <div class="content"> 
   <div class="cLineB"> 
    <h4>列表页面</h4> 
    <a href="<?php echo U('Blproduct/update',array('token'=>$token,id=>$id,'name'=>'Product'));?>"  class="right  btnGreen" style="margin-top:-27px">返回</a> 
   </div> 
...
<input type="hidden" name="id" value="<?php echo ($data["id"]); ?>" />
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      ...
      <tr> 
        <th>标题黑色部分：</th>
        <td><input type="text" name="f_black" value="<?php echo ($data["f_black"]); ?>" class="px" style="width:80px;" ></td>
       </tr>
       <tr> 
        <th>标题红色部分：</th>
        <td><input type="text" name="f_red" class="px" value="<?php echo ($data["f_red"]); ?>" style="width:80px;" ></td>
       </tr>
       <tr> 
        <th>价格：</th>
        <td><input type="text" name="f_price" class="px" value="<?php echo ($data["f_price"]); ?>" style="width:80px;" ></td>
       </tr>
       <tr> 
        <th>规格：</th>
        <td><input type="text" name="f_guige" class="px" value="<?php echo ($data["f_guige"]); ?>" style="width:80px;" ></td>
       </tr>
        <tr> 
        <th>产品图片：</th>
        <td><input type="file" name="f_pic" ><?php if($data['f_pic'] != null ): ?><img src="<?php echo ($data["f_pic"]); ?>" style="width:50px;" /><?php else: endif; ?></td>
       </tr>
       <tr> 
        <th>产品介绍：</th>
        <td><input type="file" name="f_desc_pic" ><?php if($data['f_desc_pic'] != null ): ?><img src="<?php echo ($data["f_desc_pic"]); ?>" style="width:50px;" /><?php else: endif; ?></td>
       </tr>
        <tr> 
        <th>下方大图片：</th>
        <td><input type="file" name="f_big_pic" ><?php if($data['f_big_pic'] != null ): ?><img src="<?php echo ($data["f_big_pic"]); ?>" style="width:50px;" /><?php else: endif; ?></td>
       </tr>
        <TR>
                  <TH valign="top"><label for="info">产品说明：</label></TH>
                  <TD><textarea name="f_describe" class="intro"  rows="5" style="width:200px;height:130px"><?php echo ($data["f_describe"]); ?></textarea></TD>
        </TR>  
       <tr>         
       <th>&nbsp;</th>
       <td>
