...
function calDiscount(){
  ...
  <div class="content"> 
   <div class="cLineB"> 
    <h4>课程添加</h4> 
    <a href="<?php echo U('Blproduct/index',array('token'=>$token,'name'=>'Product'));?>"  class="right  btnGreen" style="margin-top:-27px">返回</a> 
    <!-- <a href="<?php echo U('Blproduct/addproduct_f',array('id'=>$id,'name'=>'Product'));?>"  class="right  btnGreen" style="margin-top:-27px;margin-right:30px">添加封面信息</a>  -->
   </div> 
    ...
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       <tr> 
        <th>课程名称：</th> 
        <td><input type="text" name="productName" value="<?php echo ($data["productName"]); ?>" class="px" style="width:200px;" /></td> 
       </tr>
       <!--<tr> 
         <th>外链接：</th> 
       ...
       <tr> 
        ...
        <td><select name="type_id" id="">
        	<?php if(is_array($list)): foreach($list as $key=>$v): if($v[pid] == 0): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option>
        		<?php else: ?>
        		<option value="<?php echo ($v["id"]); ?>"> &nbsp;&nbsp; --<?php echo ($v["type"]); ?></option><?php endif; endforeach; endif; ?>
        </select></td> 
       </tr>
       <tr> 
        <th>授课教师：</th>
        <td><input type="text"  name="jiangshi" value="<?php echo ($data["jiangshi"]); ?>" class="px" style="width:100px;" /></td> 
       </tr>
       <tr> 
        <th>授课时间：</th>
        <td><input type="text"  name="time" value="<?php echo ($data["time"]); ?>" class="px" style="width:100px;" /></td> 
       </tr>
       <tr> 
        <th>课程价格：</th>
        <td><input type="text"  name="price" value="<?php echo ($data["price"]); ?>" class="px" style="width:100px;" /></td> 
       </tr>
       <tr> 
        <th>课时：</th>
        <td><input type="text"  name="keshi" value="<?php echo ($data["keshi"]); ?>" class="px" style="width:100px;" /></td> 
       </tr>
       <tr> 
        <th>星级：</th>
        <td><input type="text"  name="xingji" value="<?php echo ($data["xingji"]); ?>" class="px" style="width:100px;" /></td> 
       </tr>
       <tr> 
        <th>课程简介：</th>
        <td><input type="text"  name="jianjie" value="<?php echo ($data["jianjie"]); ?>" class="px" style="width:400px;" /></td> 
       </tr>
       <TR>
         <TH valign="top"><label for="pic">课程图片：</label></TH>
         <TD><input type="text" class="px"  name="pic" id="pic" value="<?php echo ($data["pic"]); ?>" style="width:580px;"  />  <script src="/tpl/static/upyun.js?<?php echo date('YmdHis',time());?>"></script><a href="###" onclick="upyunPicUpload('pic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic')">预览</a>
         </TD>
       </TR>
<!--        <tr>
       ...
       <tr>
        ...
        <!-- <tr> 
        <th>图片：</th>
        <td><input type="file" name="pic" ><?php if($data['pic'] != null ): ?><img src="<?php echo ($data["pic"]); ?>" style="width:50px;" /><?php else: endif; ?></td>
       </tr> -->
<!--        <tr> 
        <th>产品参数图片：</th>
       ...
       <TR>
                  <TH valign="top"><label for="info">课程说明：</label></TH>
                  <TD><textarea name="info" class="intro"  rows="5" style="width:200px;height:130px"><?php echo ($data["info"]); ?></textarea></TD>
        </TR> 
       <tr>         
       <th>&nbsp;</th>
       <td>
       <button type="submit" name="button" class="btnGreen">保存</button> &nbsp; <a href="<?php echo U('Blproduct/index',array('token'=>$token));?>" class="btnGray vm">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
