...
<!--  <div class="cLineD">
          ...
          <div class="cLine">
    <div class="ftip" style="margin:0 auto">高级服务号才能使用此功能，点击下面的“更新列表”便会同步您的关注用户信息</div>
</div> -->
...
<!--           <div class="cLine">
            <div class="pageNavigator left">
				...
				<a href="<?php echo U('User/Wechat_group/send_info',array('all'=>1));?>" class="btnGrayS vm bigbtn">
					<img src="tpl/User/default/common/images/text.png" class="vm">刷新所有用户信息
				</a>
            </div>
            <div class="clr"></div>
          </div>
...
<form method="post" action="<?php echo U('User/Wechat_group/setGroup');?>" id="info">
          <div style="width:70%;float:left">将选中用户转移到分组中 <select name="wechatgroupid"><?php if(is_array($groups)): $i = 0; $__LIST__ = $groups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$g): $mod = ($i % 2 );++$i;?><option value="<?php echo ($g["wechatgroupid"]); ?>"><?php echo ($g["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?></select> <input type="submit" value="转移" id="msgSearchBtn" href="" class="btnGrayS" title="转移">&nbsp;&nbsp;按分组查看用户：<select id="wechatgroupid" onchange="location.href='?s=/User/Wechat_group/index/token/bxousa1454659516/name/All/wechatgroupid/'+this.value"><?php if(is_array($groups)): $i = 0; $__LIST__ = $groups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$g): $mod = ($i % 2 );++$i;?><option value="<?php echo ($g["wechatgroupid"]); ?>"<?php if ($_GET['wechatgroupid']==$g['wechatgroupid']){echo ' selected';}?>><?php echo ($g["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?></select>
          </div>
<div style="clear:both"></div>
</div>
            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
			  ...
			  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td>
                  <a target="_blank" href="<?php echo ($list["headimgurl"]); ?>"><img src="<?php echo ($list["headimgurl"]); ?>" style="width:50px;" alt="" /></a>
					</td>
					<td><a href="index.php?g=User&m=Wechat_group&a=detail&id=<?php echo ($list["id"]); ?>"  class="thickbox" type="button"">查看详情</a></td>
