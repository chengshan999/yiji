               ...
               <TR>
                ...
                <TR>
                  ...
                  <TD>
                  	...
                  	<?php if($fenlei == null): ?>暂无分类，请添加
                  	<?php else: ?>
                  	<?php if(is_array($fenlei)): foreach($fenlei as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option>
                  		<?php if(is_array($v["fenlei"])): foreach($v["fenlei"] as $key=>$val): ?><option value="<?php echo ($val["id"]); ?>"> &nbsp;&nbsp;&nbsp; ┗ ━ ━<?php echo ($val["name"]); ?></option><?php endforeach; endif; endforeach; endif; endif; ?>
