...
<div class="main" style="    background: linear-gradient(#0c60a0, #00a8d5);">
    <div class="case_container" style="background:none;" id="height">
        <h3>在线咨询</h3>
            ...
            <div class="problem-module">
                ...
                <div class="content-question" >
                    <div class="content-img">
                        <ul>
                        	<?php if(is_array($question["pic"])): foreach($question["pic"] as $key=>$v): ?><li><a target="_blank" href="<?php echo ($v); ?>"><img src="<?php echo ($v); ?>" alt=""></a></li><?php endforeach; endif; ?>
                        </ul>
                        <div class="clear"></div>
                    </div>
