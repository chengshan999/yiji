...
function calDiscount(){
  ...
  <div class="content"> 
   <div class="cLineB"> 
    <h4>封面添加</h4> 
    <a href="<?php echo U('Question/index',array('name'=>'question'));?>"  class="right  btnGreen" style="margin-top:-27px">返回</a> 
   </div> 
    ...
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
        ...
        <?php if(is_array($fenlei)): foreach($fenlei as $key=>$v): if($v[id] == $data[type_id]): ?><option selected value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option>
        <?php else: ?>
        ...
        <TR>
                  ...
                  <TD><textarea name="question" class="intro"  rows="5" style="width:200px;height:130px"><?php echo ($data["question"]); ?></textarea></TD>
        </TR>  
        <TR>
                  <TH valign="top"><label for="info">A：</label></TH>
                  <TD><textarea name="answer" class="intro"  rows="5" style="width:200px;height:230px"><?php echo ($data["answer"]); ?></textarea></TD>
        </TR>  
       <tr>         
       <th>&nbsp;</th>
       <td>
       <button type="submit" name="button" class="btnGreen">保存</button> &nbsp; <a href="<?php echo U('Question/index',array('name'=>'question','token'=>$token));?>" class="btnGray vm">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
