...
<script type="text/javascript">
 $(document).ready(function() {
	...
	$("#iframe1").click(function(){
		tipsWindown("添加权限组","iframe:<?php echo U('Group/add',array('token=>$token'));?>","700","260","true","","true","leotheme");
	});
 });
 </script>
<div class="content">
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left"> <a href="javascript:;" title="添加" id="iframe1" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加权限组</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
		...
		<?php else: ?>
		<a href='javascript:tipsWindown("修改权限组","iframe:<?php echo U('Group/edit',array('id'=>$vo['id'],'token'=>$token));?>","700","260","true","","true","leotheme");'>修改</a> | 
		<a onclick="return confirm('确定删除吗？')" href="<?php echo U('Group/del',array('id'=>$vo['id'],'token'=>$token));?>">删除</a> | 
		<a class="ss" id="<?php echo ($vo["id"]); ?>"  href='javascript:tipsWindown("权限分配","iframe:<?php echo U('Group/divideNode',array('roleid'=>$vo['id'],'token'=>$token));?>","760","480","true","","true","leotheme");'>权限分配</a><?php endif; ?>
		</td>
