...
<script type="text/javascript">
 $(document).ready(function() {
	...
	$("#iframe1").click(function(){
		tipsWindown("添加课程类别","iframe:<?php echo U('Blproduct/taocan_add');?>","300","130","true","","true","leotheme");
	});
	$(".iframe2").click(function(){
		var id=$(this).parents("tr").find("td:first").text();
		tipsWindown("修改课程类别","iframe:index.php?g=User&m=Blproduct&a=taocan_edit&id="+id,"300","130","true","","true","leotheme");
	});
 });
 </script>  
<div class="content">
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left"> <a href="javascript:;" title="添加" id="iframe1" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加课程类别</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
