...
<div class="msgWrap">
  <form class="form" method="post"   action="<?php echo U('Flash/insert',array('tip'=>$tip,'name'=>$name));?>" enctype="multipart/form-data" >
...
<TR>
  ...
  <TD><input type="text" class="px" id="url" value="" name="url" style="width:500px" > <br />
                   </TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
