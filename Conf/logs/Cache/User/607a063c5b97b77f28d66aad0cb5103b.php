...
<thead>
	...
	<th>答题人昵称</th>
	<th>得分</th>
	<?php if(is_array($question)): foreach($question as $key=>$v): ?><th><?php echo ($v["name"]); ?></th><?php endforeach; endif; ?>
	</tr>
</thead>
<tbody>
<tr></tr>
	<?php if(is_array($answer)): foreach($answer as $key=>$v): ?><tr>
		<td><img src="<?php echo ($v["headimgurl"]); ?>" style="width:50px;" alt="" /></td>
		<td><?php echo ($v["nickname"]); ?></td>
		<td><?php echo ($v["score"]); ?></td>
		<?php if(is_array($v["answer"])): foreach($v["answer"] as $key=>$val): ?><td><?php echo ($val["huida"]); ?></td><?php endforeach; endif; ?>
