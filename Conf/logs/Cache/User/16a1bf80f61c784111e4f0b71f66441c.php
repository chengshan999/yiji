...
function calDiscount(){
  ...
  <div class="content"> 
   <div class="cLineB"> 
    <h4>产品添加</h4> 
    <a href="<?php echo U('Blproduct/liuxue',array('name'=>'liuxue'));?>"  class="right  btnGreen" style="margin-top:-27px">返回</a> 
   </div> 
      ...
      <tbody> 
       ...
       <tr> 
        ...
        <td><select name="type_name" id="">
        	...
        	<option value="澳洲游学a">澳洲游学大</option>
        	<option value="韩国游">韩国游</option>
        	<option value="韩国游a">韩国游大</option>
        	<option value="开业典礼">开业典礼</option>
        	<option value="开业典礼a">开业典礼大</option>
        	<option value="发布会场景">发布会场景</option>
        	<option value="发布会场景a">发布会场景大</option>
        	<option value="发布会新闻">发布会新闻</option>
        	<option value="发布会新闻a">发布会新闻大</option>
        </select></td> 
       </tr>
       ...
       <tr> 
        <th>产品参数图片：</th>
        <td><input type="file" multiple="true"  name="pic[]" ></td>
       </tr>
       <tr>         
       <th>&nbsp;</th>
       <td>
       <button type="submit" name="button" class="btnGreen">保存</button> &nbsp; <a href="<?php echo U('Blproduct/liuxue',array('name'=>liuxue));?>" class="btnGray vm">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
