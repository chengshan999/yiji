...
<div class="cLineB">
  <h4>banner管理 <span class="FAQ">轮播图</span></h4>
 </div>
         <div class="cLineC" style="line-height: 32px;">
 <a href="<?php echo U('Flash/add',array('name'=>'Flash'));?>" class="btnGrayS vm bigbtn" >添加轮播图</a> 
</div>
...
<th><?php if($tip == 1): ?>轮播<?php else: ?>图片<?php endif; ?> <a  target="999" class="tooltips" ><span>
</span></a></th>
                        <th><?php if($tip == 1): ?>外链地址<?php else: ?>图片外链地址<?php endif; ?><span class="tooltips" ><img src="<?php echo RES;?>/images/price_help.png" align="absmiddle" /><span>
...
<form action="<?php echo U('Flash/usort',array('tip'=>$info[0]['tip'],'name'=>'Flash'));?>" method="post">
...
<td><?php if($vo["tip"] == 1): ?>用户端<?php else: ?>医生端<?php endif; ?></td>
<td class="norightborder">
	<a href="<?php echo U('Flash/edit',array('id'=>$vo['id'],'name'=>'Flash'));?>">编辑</a>
