...
<div class="cLineB">
  <h4>活动管理 <span class="FAQ">活动列表</span></h4>
 </div>
         <div class="cLineC" style="line-height: 32px;">
 <a href="<?php echo U('Map/huodong_add',array('name'=>'map'));?>" class="btnGrayS vm bigbtn" >添加活动</a> 
</div>
...
<thead>
<tr>
				   <th style=" width:60px;">活动标号</th>
				   <th style=" width:60px;">活动名称</th>
                   <TH style=" width:60px;">活动简介</TH>
                   <TH style=" width:60px;">活动图片</TH>
                   <TH style=" width:60px;">创建时间</TH>
                    <th style=" width:60px;" class="norightborder">操作</th>
</tr>
</thead>
...
<td><img src="<?php echo ($v["pic"]); ?>" style="width:50px" alt="" /></td>
<td><?php echo (date("Y-m-d H:i",$v["createtime"])); ?></td>
<td class="norightborder">
	<a href="<?php echo U('huodong_edit',array('id'=>$v['id'],'name'=>'map'));?>">编辑</a>
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('huodong_del',array('id'=>$v['id']));?>');">删除</a>
</td>
