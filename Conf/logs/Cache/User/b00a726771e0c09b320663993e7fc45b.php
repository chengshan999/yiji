...
<div class="content">
    <div class="cLineB">
        <h4>提现名单 </h4>
        <div class="ftip" style="margin:10px 0">
            <form method="post" action="">
                <input type="text" id="openid" class="px" size="40" placeholder="请输入 OpenId 查询" name="openid" value="<?php echo ($openid); ?>">
    ...
    <script>
        $(function() {
            var a = 0;
            $(".platform_table tr").slice(1, -3).each(function() {
                a = a + parseFloat($(this).find(".money_val").val());
    ...
    <div class="msgWrap bgfc">
        <form class="form" method="post" action="<?php echo U('Tixian/add',array('name'=>$name));?>"  enctype="multipart/form-data">	 
            <table border="0" cellspacing="0" cellpadding="0" width="100%" class="platform_table">
                <tr>
                    <td class="quanxuan"><p style="width:30px">全选</p>  </td>
                    <td>提现订单号</td>
                    <td>用户名</td>
                    <td>用户Openid</td>
                    <td>提现金额(元)</td>
                ...
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td><input type="checkbox" value="<?php echo ($vo['id']); ?>" class="fuxuan" name='list[]'/></td>
                        <td><input type='text' name='order[]' value="<?php echo ($vo['order']); ?>" readonly="readonly" style='width: 221px;'/></td>
                        <td><input type='text' name='name[]' value="<?php echo ($vo['name']); ?>" readonly="readonly" /></td>
                        <td><input type='text' name='openid[]' value="<?php echo ($vo['openid']); ?>" readonly="readonly" style='width: 221px;'/></td>
                        <td><input type='text' name='jine[]' value="<?php echo ($vo['jine']); ?>" readonly="readonly" class="money_val"/></td>
                        <td><input type='text' name='yue[]' value="<?php echo ($vo['points']); ?>" readonly="readonly" /></td>
                        <td><input type='text' name='time[]' value="<?php echo ($vo['time']); ?>" readonly="readonly" class="time_input"/></td>
                    </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                <tr>
                    <td colspan="7"><div style="float:right;"><?php echo ($page); ?></div></td>
                </tr>
                <tr>
                    <td colspan="5"><div style="float:left;">总计：总金额 (<font color="blue" ><?php echo $moneys;?></font>) </div></td>
                    <td>
                        <input type="submit" value="提交" id="msgSearchBtn" href=""  style="color:#000;font-size:14px;padding:1px 24px;background:#4A98E0;">
                        <!-- <input type='submit'  style="color:#000;font-size:14px;padding:1px 24px;background:#4A98E0;"value='提交'/></span> -->
                    </td>

                    <td>
                        <a href="<?php echo U('Tixian/select',array('name'=>$name));?>" style="color:#000;font-size:14px;background:#4A98E0;padding: 2px 24px;">查询</a></span>
                    </td>
                </tr>
            </table>
