...
<div class="cLineB">
<?php if($tip == 1): ?><h4>推荐位管理 <span class="FAQ">视野推荐位轮播图</span></h4>
<?php else: ?>
  <h4>推荐位管理 <span class="FAQ">产品推荐位轮播图</span></h4><?php endif; ?>
 </div>
         <div class="cLineC" style="line-height: 32px;">
 <a href="<?php echo U('Flashs/add',array('tip'=>$tip,'name'=>$name));?>" class="btnGrayS vm bigbtn" ><?php if($tip == 1): ?>添加轮播图<?php else: ?>添加图片<?php endif; ?></a> 
</div>
...
<th><?php if($tip == 1): ?>轮播<?php else: ?>图片<?php endif; ?> <a  target="999" class="tooltips" ><img src="<?php echo RES;?>/images/price_help.png" align="absmiddle" /><span>
...
<form action="<?php echo U('Flashs/usort',array('tip'=>$info[0]['tip'],'name'=>$name));?>" method="post">
...
<td class="norightborder">
	<a href="<?php echo U('Flashs/edit',array('id'=>$vo['id'],'tip'=>$tip,'name'=>$name));?>">编辑</a>
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Flashs/del',array('id'=>$vo['id'],'tip'=>$tip,'name'=>$name));?>');">删除</a>
</td>
