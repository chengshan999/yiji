...
function calDiscount(){
  ...
  <div class="content"> 
   <div class="cLineB"> 
    <h4>比赛添加</h4> 
    <a href="<?php echo U('Bisai/index',array('token'=>$token,'name'=>'Bisai'));?>"  class="right  btnGreen" style="margin-top:-27px">返回</a> 
   </div> 
    ...
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       ...
       <tr> 
        <th>主持教师：</th>
        <td><select name="jiangshi_id" id="">
        	<?php if(is_array($jiangshi)): foreach($jiangshi as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?>(<?php echo ($v["zhiwei"]); ?>)</option><?php endforeach; endif; ?>
        </select></td> 
       </tr>
       <tr> 
        <th>比赛时间：</th>
       ...
       <tr> 
        <th>总时长：</th>
        <td><input type="text"  name="total_time" value="<?php echo ($data["total_time"]); ?>" class="px" style="width:100px;" /></td> 
       </tr>
       <tr> 
        <th>热门星级（0-5）：</th>
       ...
       <tr> 
        <th>比赛简介：<br />（显示在列表页）</th>
        <td><input type="text"  name="jianjie" value="<?php echo ($data["jianjie"]); ?>" class="px" style="width:600px;" /></td> 
       </tr>
       <TR>
         <TH valign="top"><label for="pic">比赛图片：</label></TH>
...
<!--        <tr> 
       ...
       <TR>
                  <TH valign="top"><label for="info">比赛介绍：</label></TH>
                  <TD><textarea name="info" class="intro"  rows="5" style="width:200px;height:130px"><?php echo ($data["info"]); ?></textarea></TD>
        </TR> 
       <TR>
                  <TH valign="top"><label for="info">比赛安排：</label></TH>
                  <TD><textarea name="anpai" class="intro"  rows="5" style="width:200px;height:130px"><?php echo ($data["anpai"]); ?></textarea></TD>
        </TR> 
       <tr>         
       <th>&nbsp;</th>
       <td>
       <button type="submit" name="button" class="btnGreen">保存</button> &nbsp; <a href="<?php echo U('Bisai/index',array('token'=>$token));?>" class="btnGray vm">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
