...
function calDiscount(){
  ...
  <div class="content"> 
   <div class="cLineB"> 
    <h4>讲师添加</h4> 
    <a href="<?php echo U('Jiangshi/index',array('token'=>$token,'name'=>'Jiangshi'));?>"  class="right  btnGreen" style="margin-top:-27px">返回</a> 
   </div> 
    ...
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       <tr> 
        <th>讲师名称：</th> 
        <td><input type="text" name="name" class="px" style="width:100px;" /></td> 
       </tr>
       <tr> 
        <th>讲师职位：</th> 
        <td><input type="text" name="zhiwei" class="px" style="width:100px;" /></td> 
       </tr>
       <tr> 
        <!-- <th>外链接：</th> 
...
<!--    <tr> 
       ...
       <TR>
                  ...
                  <TD><textarea name="info" class="intro"  rows="5" style="width:200px;height:130px"><?php echo ($data["remark"]); ?></textarea></TD>
        </TR> 
       <tr>         
       <th>&nbsp;</th>
       <td>
