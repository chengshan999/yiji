...
<tbody>
	<tr>
		<td class="td_left">服务器系统：</td>
		<td>[<?php echo PHP_OS; ?>]<?php echo $_SERVER[SERVER_SOFTWARE];?></td>
	</tr>
	<tr>
		<td class="td_left">数据库版本：</td>
		<td>MySql:<?php echo mysql_get_server_info(); ?></td>
	</tr>
	<tr>
		<td class="td_left">PHP版本：</td>
		<td>php:<?php echo PHP_VERSION; ?></td>
	</tr>
	<tr>
		<td class="td_left">服务器IP：</td>
		<td><?php echo $_SERVER['SERVER_ADDR']; ?></td>
	</tr>
	<tr>
		<td class="td_left">端口号：</td>
		<td><?php echo $_SERVER['SERVER_PORT']; ?></td>
	</tr>
	<tr>
		<td class="td_left">当前网站语言：</td>
		<td><?php echo getenv("HTTP_ACCEPT_LANGUAGE"); ?></td>
	</tr>
	<tr>
		<td class="td_left">被屏蔽的函数：</td>
		<td><?php echo get_cfg_var("disable_functions")?get_cfg_var("disable_functions"):"无" ; ?></td>
	</tr>
	<tr>
		<td class="td_left">文件上传大小：</td>
		<td><?php echo ini_get('upload_max_filesize'); ?></td>
	</tr>
	<tr>
		<td class="td_left">官方网站：</td>
		<td><a href="<?php echo C('h_site_url');?>" class="blue" target="_blank"><?php echo C('h_site_name');?></a></td>
	</tr>
</tbody>
</table>
</div>
