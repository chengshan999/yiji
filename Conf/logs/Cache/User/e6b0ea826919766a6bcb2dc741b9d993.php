...
<div class="welcome">欢迎使用真珠美学后台管理平台!</div>
...
<script type="text/javascript">
 $(document).ready(function() {
	...
	$("#iframe1").click(function(){
		tipsWindown("修改活动时间","iframe:<?php echo U('Blproduct/liuxue_time',array('token=>$token'));?>","300","130","true","","true","leotheme");
	});
 });
 </script> 
        <div class="content">
...
<div class="tab">
<ul>
<li class="current tabli" id="tab0">图片管理</li>

</ul>
</div>
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left" style="margin-left:20px"> <a  href="<?php echo U('Blproduct/liuxue_add',array('name'=>liuxue));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加图片</a>  <a href="javascript:;" style="margin-left:20px" title="修改" id="iframe1" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">修改活动时间</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
<form method="post" action="" >
...
<tr></tr>
<tr>
<td><input type="number" style=" width:40px;border:1px solid #c9c9c9;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;" class="usort" name="sort[<?php echo ($vo["id"]); ?>]" value="<?php echo ($vo["sort"]); ?>" /></td>
<td>澳洲留学</td>
<td><?php echo ($aozhou); ?></td>
<td class="norightborder"><a href="<?php echo U('Blproduct/liuxue_edit',array('name'=>'liuxue','type_name'=>'澳洲游学'));?>">修改</a>   <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Blproduct/liuxue_delete',array('name'=>'澳洲游学','token'=>$token));?>');">删除</a></td>
</tr>
<tr>
<td><input type="number" style=" width:40px;border:1px solid #c9c9c9;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;" class="usort" name="sort[<?php echo ($vo["id"]); ?>]" value="<?php echo ($vo["sort"]); ?>" /></td>
<td>澳洲留学大图</td>
<td><?php echo ($aozhou_big); ?></td>
<td class="norightborder"><a href="<?php echo U('Blproduct/liuxue_edit',array('name'=>'liuxue','type_name'=>'澳洲游学a'));?>">修改</a>   <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Blproduct/liuxue_delete',array('name'=>'澳洲游学a','token'=>$token));?>');">删除</a></td>
</tr>
<tr>
<td><input type="number" style=" width:40px;border:1px solid #c9c9c9;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;" class="usort" name="sort[<?php echo ($vo["id"]); ?>]" value="<?php echo ($vo["sort"]); ?>" /></td>
<td>韩国游</td>
<td><?php echo ($hanguo); ?></td>
<td class="norightborder"><a href="<?php echo U('Blproduct/liuxue_edit',array('name'=>'liuxue','type_name'=>'韩国游'));?>">修改</a>   <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Blproduct/liuxue_delete',array('name'=>'韩国游','token'=>$token));?>');">删除</a></td>
</tr>
<tr>
<td><input type="number" style=" width:40px;border:1px solid #c9c9c9;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;" class="usort" name="sort[<?php echo ($vo["id"]); ?>]" value="<?php echo ($vo["sort"]); ?>" /></td>
<td>韩国游大图</td>
<td><?php echo ($hanguo_big); ?></td>
<td class="norightborder"><a href="<?php echo U('Blproduct/liuxue_edit',array('name'=>'liuxue','type_name'=>'韩国游a'));?>">修改</a>   <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Blproduct/liuxue_delete',array('name'=>'韩国游a','token'=>$token));?>');">删除</a></td>
</tr>
<tr>
<td><input type="number" style=" width:40px;border:1px solid #c9c9c9;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;" class="usort" name="sort[<?php echo ($vo["id"]); ?>]" value="<?php echo ($vo["sort"]); ?>" /></td>
<td>开业典礼</td>
<td><?php echo ($kaiye); ?></td>
<td class="norightborder"><a href="<?php echo U('Blproduct/liuxue_edit',array('name'=>'liuxue','type_name'=>'开业典礼'));?>">修改</a>   <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Blproduct/liuxue_delete',array('name'=>'开业典礼','token'=>$token));?>');">删除</a></td>
</tr>
<tr>
<td><input type="number" style=" width:40px;border:1px solid #c9c9c9;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;" class="usort" name="sort[<?php echo ($vo["id"]); ?>]" value="<?php echo ($vo["sort"]); ?>" /></td>
<td>开业典礼大图</td>
<td><?php echo ($kaiye_big); ?></td>
<td class="norightborder"><a href="<?php echo U('Blproduct/liuxue_edit',array('name'=>'liuxue','type_name'=>'开业典礼a'));?>">修改</a>   <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Blproduct/liuxue_delete',array('name'=>'开业典礼a','token'=>$token));?>');">删除</a></td>
</tr>
<tr>
<td><input type="number" style=" width:40px;border:1px solid #c9c9c9;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;" class="usort" name="sort[<?php echo ($vo["id"]); ?>]" value="<?php echo ($vo["sort"]); ?>" /></td>
<td>发布会场景</td>
<td><?php echo ($changjing); ?></td>
<td class="norightborder"><a href="<?php echo U('Blproduct/liuxue_edit',array('name'=>'liuxue','type_name'=>'发布会场景'));?>">修改</a>   <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Blproduct/liuxue_delete',array('name'=>'发布会场景','token'=>$token));?>');">删除</a></td>
</tr>
<tr>
<td><input type="number" style=" width:40px;border:1px solid #c9c9c9;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;" class="usort" name="sort[<?php echo ($vo["id"]); ?>]" value="<?php echo ($vo["sort"]); ?>" /></td>
<td>发布会场景大图</td>
<td><?php echo ($changjing_big); ?></td>
<td class="norightborder"><a href="<?php echo U('Blproduct/liuxue_edit',array('name'=>'liuxue','type_name'=>'发布会场景a'));?>">修改</a>   <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Blproduct/liuxue_delete',array('name'=>'发布会场景a','token'=>$token));?>');">删除</a></td>
</tr>
<tr>
<td><input type="number" style=" width:40px;border:1px solid #c9c9c9;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;" class="usort" name="sort[<?php echo ($vo["id"]); ?>]" value="<?php echo ($vo["sort"]); ?>" /></td>
<td>发布会新闻</td>
<td><?php echo ($xinwen); ?></td>
<td class="norightborder"><a href="<?php echo U('Blproduct/liuxue_edit',array('name'=>'liuxue','type_name'=>'发布会新闻'));?>">修改</a>   <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Blproduct/liuxue_delete',array('name'=>'发布会新闻','token'=>$token));?>');">删除</a></td>
</tr>
<tr>
<td><input type="number" style=" width:40px;border:1px solid #c9c9c9;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;" class="usort" name="sort[<?php echo ($vo["id"]); ?>]" value="<?php echo ($vo["sort"]); ?>" /></td>
<td>发布会新闻大图</td>
<td><?php echo ($xinwen_big); ?></td>
<td class="norightborder"><a href="<?php echo U('Blproduct/liuxue_edit',array('name'=>'liuxue','type_name'=>'发布会新闻a'));?>">修改</a>   <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Blproduct/liuxue_delete',array('name'=>'发布会新闻a','token'=>$token));?>');">删除</a></td>
</tr>
</tbody>
</table>
<?php if(!empty($data)): ?><input style="margin-left:5px" class="btnGrayS" type="submit" value="确认" /><?php endif; ?>
</form>
<script>
...
<div class="foot">
<div class="foot_page" >
<a style="padding-left:90px" href="<?php echo ($f_siteUrl); ?>">真珠美学</a>
</div>
<div id="copyright" style="color:#000;">
	真珠美学(c)版权所有 <a href="http://www.miibeian.gov.cn" target="_blank" style="color:#000"><?php echo C('ipc');?></a>
