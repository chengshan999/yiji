...
<div class="tab">
<ul>
<li class="current tabli" id="tab0">常见问题管理 </li>
</ul>
</div>
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left" style="margin-left:20px"> <a href="<?php echo U('Question/fenlei_index',array('name'=>question));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">问题分类设置</a></div>
<div class="pageNavigator left" style="margin-left:20px"> <a href="<?php echo U('Question/add',array('name'=>question));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">问题添加</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
<form method="post" action="" >
...
<td class="norightborder"><a href="<?php echo U('Question/update',array('id'=>$vo['id'],'token'=>$token,'name'=>'question'));?>">修改</a>   <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Question/delete',array('id'=>$vo['id'],'token'=>$token));?>');">删除</a></td>
