...
<div class="tab">
<ul>
<li class="current tabli" id="tab0"><a href="<?php echo U('Research/index', array('name' => 'Wenjuan'));?>">问卷列表</a></li>
<li class="tabli" id="tab0"><a href="<?php echo U('Research/saveInfo', array('name' => 'Wenjuan'));?>">添加问卷</a></li>
</ul>
</div>
<div class="cLine">
<div class="clr"></div>
...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tablelist): $mod = ($i % 2 );++$i;?><tr>
		...
		<td><?php if($tablelist["pic"] != null): ?><img src="<?php echo ($tablelist["pic"]); ?>" width="50px" alt="" /><?php endif; ?></td>
		...
		<td class="norightborder">
			<a href="<?php echo U('Research/saveInfo', array('rid' => $tablelist['id'], 'name' => 'Wenjuan'));?>">修改</a> 
			<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Research/delResearch',array('rid' => $tablelist['id'], 'name' => 'Wenjuan'));?>');">删除</a>
			<a href="<?php echo U('Research/count',array('rid' => $tablelist['id'], 'name' => 'Wenjuan'));?>">选项统计</a>
			<a href="<?php echo U('Research/answer',array('rid' => $tablelist['id'], 'name' => 'Wenjuan'));?>">具体回答</a>
			<a target="_blank" href="<?php echo U('Research/qcode',array('rid' => $tablelist['id']));?>">答题二维码</a>
		</td>
