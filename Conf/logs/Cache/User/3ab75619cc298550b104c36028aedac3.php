...
<script type="text/javascript">
 $(document).ready(function() {
	...
	$("#iframe1").click(function(){
		tipsWindown("问题分类添加","iframe:<?php echo U('Question/fenlei_add',array('token=>$token'));?>","400","130","true","","true","leotheme");
	});
	$(".iframe2").click(function(){
		var id=$(this).parents("tr").find("td:first").text();
		tipsWindown("修改问题分类","iframe:index.php?g=User&m=Question&a=type_edit&token=<?php echo ($token); ?>&id="+id,"400","130","true","","true","leotheme");
	});
 });
 </script>
        <div class="content">
<div class="cLineB">
<h4 class="left">问题分类管理 </h4>
<a href="<?php echo U('Question/index',array('name'=>'question','token'=>$token,id=>$id));?>"  class="right  btnGreen" style="margin-top:0px;">返回</a> 
...
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left" style="margin-left:20px"> <a href="javascript:;" title="添加" id="iframe1" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">问题分类添加</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<tbody>
<tr></tr>
<?php if(is_array($fenlei)): $i = 0; $__LIST__ = $fenlei;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
<td><?php echo ($vo["id"]); ?></td>
<td><?php echo ($vo["name"]); ?></td>
<td class="norightborder"><a href="javascript:;" title="修改"  class="iframe2" >修改</a>   <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Question/type_delete',array('id'=>$vo['id'],'token'=>$token));?>');">删除</a></td>
