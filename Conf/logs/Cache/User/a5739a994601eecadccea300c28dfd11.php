...
<script type="text/javascript">
 $(document).ready(function() {
	...
	$("#iframe1").click(function(){
		tipsWindown("添加产品","iframe:<?php echo U('Blproduct/point_add',array('token=>$token'));?>","380","350","true","","true","leotheme");
	});
	$(".iframe2").click(function(){
		var id=$(this).parents("tr").find("td:first").text();
		tipsWindown("修改产品","iframe:index.php?g=User&m=Blproduct&a=point_edit&token=<?php echo ($token); ?>&id="+id,"380","380","true","","true","leotheme");
	});
 });
 </script>  
        <div class="content">
<div class="cLineB">
<h4 class="left">积分商城 </h4>
...
<div class="tab">
<ul>
<li class="current tabli" id="tab0">商品管理</li>
</ul>
</div>
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left" style="margin-left:20px"> <a href="javascript:void(0);" id="iframe1" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加商品</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
<form method="post" action="" >
...
<td><?php echo ($vo["rongyu"]); ?></td>
<td><?php echo ($vo["kucun"]); ?></td>
<td class="norightborder"><a href="javascript:void(0);" class="iframe2">修改</a>   <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Blproduct/point_delete',array('id'=>$vo['id'],'token'=>$token));?>');">删除</a></td>
