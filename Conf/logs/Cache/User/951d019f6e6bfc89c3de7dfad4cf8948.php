...
<script src="/tpl/static/artDialog/plugins/iframeTools.js"></script>
 <div class="content" <?php if(session('isQcloud') == true): ?>style="float:center;"<?php endif; ?>>
          <div class="cLineB"><h4><?php if($tip == 1): ?>添加幻灯片<?php else: ?>添加活动<?php endif; ?></h4><a href="javascript:history.go(-1);"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a></div> 
<div class="msgWrap">
...
<TABLE class="userinfoArea" style=" margin:20px 0 0 0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
  ...
  <TD><input type="text" class="px" id="url" value="" name="name" style="width:500px" > <br />
                   </TD>
  <TD>&nbsp;</TD>
</TR>
