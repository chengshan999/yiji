...
<div class="tab">
<ul>
<li class="current tabli" id="tab0">比赛管理</li>
</ul>
</div>
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left" style="margin-left:20px"> <a href="<?php echo U('Bisai/addproduct',array('name'=>Product));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加比赛</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
<form method="post" action="" >
...
<tr>
<th width="60">排序</th>
<th width="180">比赛名称名称</th>
<th width="100">图片</th>
<th width="200">比赛简介</th>
...
<td class="norightborder"><a href="<?php echo U('Bisai/update',array('id'=>$vo['id'],'token'=>$token,'name'=>'Bisai'));?>">修改</a>   <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Bisai/delete',array('id'=>$vo['id'],'token'=>$token));?>');">删除</a></td>
