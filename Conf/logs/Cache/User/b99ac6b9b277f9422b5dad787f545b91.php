...
<script type="text/javascript">
 $(document).ready(function() {
	...
	$("#iframe1").click(function(){
		tipsWindown("添加地区","iframe:<?php echo U('Yiyuan/diqu_add');?>","300","130","true","","true","leotheme");
	});
	$("#iframe2").click(function(){
		tipsWindown("添加医院","iframe:<?php echo U('Yiyuan/yiyuan_add');?>","300","130","true","","true","leotheme");
	});
	$(".iframe3").click(function(){
		var id=$(this).attr('id');
		tipsWindown("修改","iframe:index.php?g=User&m=Yiyuan&a=yiyuan_edit&id="+id,"300","130","true","","true","leotheme");
	});
 });
 </script>  
<div class="content">
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left"> <a href="javascript:;" title="添加" id="iframe1" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加地区</a></div>
<div class="pageNavigator left" style="margin-left:3%;"> <a href="javascript:;" title="添加" id="iframe2" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加医院</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<tbody>
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tablelist): $mod = ($i % 2 );++$i; if(is_array($tablelist['yiyuan'])): $k = 0; $__LIST__ = $tablelist['yiyuan'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$answer): $mod = ($k % 2 );++$k;?><tr>
		<?php if($k == 1): ?><td rowspan="<?php echo ($tablelist['rowspan']); ?>"><?php echo ($tablelist['name']); ?></td><?php endif; ?>
		<td><?php echo ($answer['name']); ?></td>
		<td><?php echo ($answer['addr']); ?></td>
		<td><?php echo ($answer['tel']); ?></td>
		<td><a href="javascript:void(0)" id="<?php echo ($answer["id"]); ?>" class="iframe3">修改</a> &nbsp;  <a href="<?php echo U('Yiyuan/delete_yiyuan',array('id'=>$answer[id]));?>">删除</a></td>
