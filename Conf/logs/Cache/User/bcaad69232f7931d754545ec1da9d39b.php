...
<script type="text/javascript">
 $(document).ready(function() {
	...
	$("#iframe1").click(function(){
		tipsWindown("添加医生","iframe:<?php echo U('Yiyuan/yisheng_add');?>","330","160","true","","true","leotheme");
	});
	$(".iframe2").click(function(){
		var id=$(this).parents("tr").find("td:first").text();
		tipsWindown("医生编辑","iframe:index.php?g=User&m=Yiyuan&a=yisheng_edit&id="+id,"330","160","true","","true","leotheme");
	});
 });
 </script>  
<div class="content">
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left"> <a href="javascript:;" title="添加" id="iframe1" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加医生</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<tbody>
<?php if(is_array($yisheng)): $i = 0; $__LIST__ = $yisheng;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
		<td><?php echo ($vo["id"]); ?></td>
		<td><?php echo ($vo["xingming"]); ?></td>
		<td><?php echo ($vo["tel"]); ?></td>
		<td><?php echo ($vo["yiyuan"]); ?></td>
		<td><a href="javascript:void(0)" class="iframe2">修改</a> &nbsp;  <a href="<?php echo U('Yiyuan/delete_yisheng',array('id'=>$vo[id]));?>">删除</a></td>
