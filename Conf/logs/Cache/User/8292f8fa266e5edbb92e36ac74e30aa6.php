...
<script type="text/javascript">
 $(document).ready(function() {
	...
	$("#iframe1").click(function(){
		tipsWindown("添加资讯分类","iframe:<?php echo U('Img/fenlei');?>","500","150","true","","true","leotheme");
	});
 });
 </script> 
<div class="content" <?php if(session('isQcloud') == true): ?>style="float:center;"<?php endif; ?>>
          ...
          <div class="cLineB">
              <h4 class="left">站内资讯</h4>
              <div class="clr"></div>
          </div>
          <div class="cLine">
              <div class="pageNavigator left">
                <a href='<?php echo U("Img/add",array("name"=>$name));?>' title='添加新闻' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/pic.png" class="vm" />发布资讯</a>　
                <a id="iframe1" title='添加分类' class='btnGrayS vm bigbtn'>添加资讯分类</a>　
            ...
            <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
              ...
              <TBODY>
				...
				<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "没有找到数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td><select name="display" id ="<?php echo ($vo["id"]); ?>" >
                  <?php if($vo['display'] == 1): ?><option value="1" selected>推荐</option>
                  <option value="0">不推荐</option>
                  <?php else: ?>
                  <option value="1" >推荐</option>
                  <option value="0" selected>不推荐</option><?php endif; ?>
                  </select></td>
                  ...
                  <td><?php echo ($vo["type"]); ?></td>
				   ...
				   <a href="<?php echo U('Img/edit',array('id'=>$vo['id'],'name'=>$name));?>" title="编辑图文自定义回复">编辑</a>
				   <a href="<?php echo U('Img/del',array('id'=>$vo['id'],'name'=>$name));?>">删除</a></td>
