...
<title><?php echo ($f_siteName); ?>-微极快WM后台管理系统</title>
<meta name="keywords" content="<?php echo ($f_siteName); ?>-微极快WM后台管理系统" />
<meta name="description" content="<?php echo ($f_siteName); ?>-微极快WM后台管理系统" />
  ...
  <tr>
	...
	<div class="top">
    	<a href="/" class="logo" title="首页">首页</a>
		 <div class="login">
			<li>您好：<b><?php echo (session('username')); ?></b> ，欢迎使用微极快WM！</li>	
			<li><a href="/index.php" target="_blank"> 访问首页</a></li>
			<li><a href="/index.php?g=User&m=Index&a=index" target="_blank">用户中心</a></li>
			<li><a href="http://wm.b2ctui.com">官方网址</a></li>
			<li><a href="http://wm.b2ctui.com">官方论坛</a></li>
...
<div class="topnav">
    	<p><a href="javascript:void(0)" id="togglemenu">隐藏菜单</a>加班加点升级中,更多功能，开发中...！</div>
    </div>
    <i class="tico"></i>
</div></td>
  </tr>
...
<p class="fr"> Copyright &copy; 2012-2013 微极快WM(7.8)版权所有  </p>
</div></td>
  </tr>
</table>
</body>
