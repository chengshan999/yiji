...
function addLink(domid,iskeyword){
	art.dialog.data('domid', domid);
	art.dialog.open('/index.php?wbs=User&cms=Link&a=insert&iskeyword='+iskeyword,{lock:true,title:'插入链接或关键词',width:600,height:400,yesText:'关闭',background: '#000',opacity: 0.45});
}