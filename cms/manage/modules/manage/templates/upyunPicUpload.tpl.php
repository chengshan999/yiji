...
$bucket = $this->bucket; /// 空间名
		...
		$options['return-url'] = C('site_url').'/index.php?wbs=User&cms=Upyun&a=uploadReturn'; /// 页面跳转型回调地址
...
$options['return-url'] = 'http://demo.wbscms.com/cms/manage/admin.php?m=manage&c=background&a=upyunPicUpload'; /// 页面跳转型回调地址
//$options['notify-url'] = 'http://demo.wbscms.com/cms/manage/admin.php?m=manage&c=background&a=upyunPicUpload'; /// 服务端异步回调地址, 请注意该地址必须公网可以正常访问
