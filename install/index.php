...
'license'=>'<div class="license"><h1>系统安装协议</h1>
				...
				<p>感谢您选择微极快WM微信公共平台基于 PHP + MySQL   的技术开发，全部源码开放。</p>
			...
			<strong>二、协议许可的权利 </strong>
				...
				<p>2、您可以在协议规定的约束和限制范围内修改 微极快WM微信公共平台源代码或界面风格以适应您的网站要求。 </p>
			...
			<strong>三、协议规定的约束和限制 </strong>
				...
				<p>3、不管你的网站是否整体使用 微极快WM微信公共平台，还是部份栏目使用 微信公共平台，在你使用了 微极快WM微信公共平台的网站主页上必须加上 微极快WM微信公共平台  官方网址(<a href="http://yunm.taobao.com" target="_blank">yunm.taoao.com</a>)的链接。</p>
				<p>4、未经官方许可，禁止在 微极快WM微信公共平台  的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
			...
			<strong>四、有限担保和免责声明 </strong>
				...
				<p><b>版本最新更新：</b> 2014年10月10日</p>
                <p align=right>BY 微极快WM微信公共平台</p>
</div>',
'agreement_yes' => '我同意，继续安装',
'agreement_no' => '我不同意',
'title_install' => ' 微极快WM微信公共平台V'.SOFT_VERSION.' 安装程序',
...
'confirm_set_remark'=>'我已经仔细阅读了以上说明，可以进入后台了'
);
//-----------------------语言包end
...
(1, '".$username."', '".$password."', 5, 1, '', $time, '127.0.0.1', '')");
			$db->query("INSERT INTO `{$tablepre}users` (`id`,`gid`,`hid`, `username`, `password`,`createtime`,`lasttime`,`status`,`createip`,`lastip`,`viptime`,`card_num`,`connectnum`,`lastloginmonth`,`attachmentsize`,`invitecode`) VALUES
(1,4,1, '".$username."', '".$password."',$time,$time,1,'127.0.0.1','127.0.0.1',1893427200,9999,225,7,63509649,'sxfzcf')");
			//新增一个标识文件，用来屏蔽重新安装
...
<meta content="微极快WM微信公共平台" name="Copyright" />
...
?>
			<div class="footer">
			    <p>Powered by 微极快WM微信公共平台(c) v7.1 2013-2014</p>
				<p>版权所有</p>
			</div>
		</div>
		</div>
